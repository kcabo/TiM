...
Vue.component('form-component', {
  ...
  <div class="form-unit">
    ...
    <div class="toggle-button" v-bind:class="{active: showChoices}" v-on:touchend.prevent="showChoices=!showChoices" v-on:click.prevent="showChoices=!showChoices">
    ...
    <div class="form-wrapper">
      ...
      <div class="delete-icon" v-show="showDelete" v-on:click="content=''">
